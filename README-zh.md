...
<p align="center">
  <a href="README.md">🇬🇧 English</a> · <a href="#快速开始">快速开始</a> · <a href="#架构">架构</a> · <a href="docs/index.html">网站</a>
</p>
...
Infernux 尝试暴露一套可以被理解、被推演的渲染架构。Python 侧的渲染编排最终落入原生 RenderGraph 后端，而不是消失在黑盒编辑器管线中。
目标

### 渲染可编排

渲染管线通过 RenderGraph API 暴露，可以用 Python 编写和修改渲染 Pass，而不是面对一个封闭的编辑器管线。

### 快速迭代

Python 不只处理玩法脚本，也负责编辑器扩展、资产工作流和工具开发，让内循环尽可能短。
...
- UI 编辑器基础与项目启动器
- 基于 GUID 的 AssetDatabase、.meta 文件与依赖追踪
