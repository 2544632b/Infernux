 ...
 *
 * Ownership: InfEngine creates AssetDatabase and hands it to AssetRegistry
...
class AssetRegistry
{
  ...
  private:
    ...
    std::unordered_map<std::string, std::shared_ptr<InfMaterial>> m_builtinMaterials; // name → builtin mat
};
