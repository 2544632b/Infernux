if(NOT DEFINED INFENGINE_SOURCE_DIR OR INFENGINE_SOURCE_DIR STREQUAL "")
    message(FATAL_ERROR "INFENGINE_SOURCE_DIR is required")
endif()
...
execute_process(
    COMMAND "${PYTHON_EXECUTABLE}" -c
        "import importlib.metadata, pathlib, sys; d = importlib.metadata.distribution('InfEngine'); direct_url = d.read_text('direct_url.json'); editable = direct_url is not None and '\"editable\": true' in direct_url; sys.exit(0 if editable else 1)"
...
if(_editable_check EQUAL 0)
    message(STATUS "InfEngine is installed as editable — skipping wheel install (the .pyd was already copied by POST_BUILD)")
    return()
endif()

# ── Regular wheel install ────────────────────────────────────────────────
file(GLOB WHEELS "${INFENGINE_SOURCE_DIR}/dist/*.whl")

list(LENGTH WHEELS WHEEL_COUNT)
if(WHEEL_COUNT EQUAL 0)
    message(FATAL_ERROR "No wheel found in ${INFENGINE_SOURCE_DIR}/dist")
endif()
