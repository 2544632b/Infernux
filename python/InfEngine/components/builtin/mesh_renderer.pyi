...
class MeshRenderer(BuiltinComponent):
    ...
    def render_material(self) -> Any:
        """The primary material used for rendering."""
        ...
    ...
    def material_guid(self) -> str:
        """The asset GUID of the primary material."""
        ...
    @material_guid.setter
    def material_guid(self, value: str) -> None: ...

    def has_render_material(self) -> bool:
        """Return whether a render material is currently assigned."""
        ...
    ...
    def get_mesh_asset(self) -> Any:
        """Return the InfMesh asset object, or None."""
        ...
