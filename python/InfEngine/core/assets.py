...
class AssetManager:
    ...
    def _ensure_execution_strategies(cls):
        ...
        from InfEngine.core.asset_types import write_texture_import_settings, write_audio_import_settings, write_mesh_import_settings
    ...
    def _invalidate_texture_ui_cache(cls, path: str) -> None:
        ...
        try:
            from InfEngine.ui import get_shared_cache
    ...
    def on_asset_deleted(cls, path: str) -> None:
        ...
        import os
        from InfEngine.core.asset_types import IMAGE_EXTENSIONS, MATERIAL_EXTENSIONS
    ...
    def on_asset_moved(cls, old_path: str, new_path: str) -> None:
        ...
        import os
        from InfEngine.core.asset_types import IMAGE_EXTENSIONS
