...
from InfEngine.components import InfComponent, SerializableObject, serialized_field, FieldType
...
from InfEngine.core import Material, Texture
from InfEngine.core.asset_ref import TextureRef
from InfEngine.lib import InfMaterial
...
class RefViewComponent(InfComponent):
    mat: Material = None
    tex: Texture = None
...
def _make_material() -> Material:
    return Material.from_native(InfMaterial.create_default_lit())
